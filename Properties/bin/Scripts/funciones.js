$(document).ready(function () {
    ...
    */
    ...
    $.get('/SAG_5/Personal/Especialidad/' + $(this).val(), function (response) {
    ...
    */
    ...
    if ($('#ProfesionID').val() != "1" && $('#ProfesionID').val() != undefined) {
        ...
        $.get('/SAG_5/Personal/Especialidad/' + $('#ProfesionID').val(), function (response) {
            var Especialidades = $.parseJSON(response);
            var ddlEspecialidades = $('#EspecializacionID');
            $('#EspecializacionID > option').remove();
            if (Especialidades.length == 0) {
    ...
    */
    ...
    $("#ComprobanteEgreso").click(function () {
        window.open("/SAG_5/Reintegros/ListadoDetalles/", 'Reintegros', 'width=800,height=400');
        return false;
    });
    ...
    $("#exportarPresupuestoExcel").change(function () {
        ...
        if (value != "") {
            if (value == "Anual") {
                window.open('/SAG_5/Presupuesto/Excel?Periodo=' + periodo, '', '');
            }else if (value == "1S") {
                window.open('/SAG_5/Presupuesto/ExcelSemestre1?Periodo=' + periodo, '', '');
            } else if (value == "2S") {
                window.open('/SAG_5/Presupuesto/ExcelSemestre2?Periodo=' + periodo, '', '');
            } else if (value == "2S") {
    ...
    $("#exportarBalanceExcel").change(function () {
        ...
        if (value != "") {
            if (value == "Anual") {
                window.open('/SAG_5/Presupuesto/ExcelBalance?Periodo=' + periodo, '', '');
            } else if (value == "1S") {
                window.open('/SAG_5/Presupuesto/ExcelBalanceSemestre1?Periodo=' + periodo, '', '');
            } else if (value == "2S") {
                window.open('/SAG_5/Presupuesto/ExcelBalanceSemestre2?Periodo=' + periodo, '', '');
            } else if (value == "2S") {
                window.open('/SAG_5/Presupuesto/Excel', '', '');
            } else if (value == "1T") {
                window.open('/SAG_5/Presupuesto/Excel', '', '');
    ...
    */
    ...
    $(".BuscarPopUpPersonal").click(function(){
        if ($(".tipobeneficiario #tipoBeneficiario").val() == "1") {
            window.open("/SAG_5/Personal/PopUp", 'BuscarPersona', 'width=750,height=400,scrollbars=yes,menubar=no,toolbars=no');
        } else if ($(".tipobeneficiario #tipoBeneficiario").val() == "2") {
            window.open("/SAG_5/Proveedores/PopUp", 'BuscarProveedor', 'width=750,height=400,scrollbars=yes,menubar=no,toolbars=no');
        }
        return false;
    });
